...
<body>
    ...
    <section id="wrapper">
        ...
        <div class="login-register" style="background-color:#dedede;">
                ...
                <form class="form-horizontal form-material" id="login-form" action="<?php echo base_url('auth/log'); ?>" method="post">
                    ...
                    <!-- <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Don't have an account? <a href="<?php echo base_url('pages/register') ?>" class="text-info m-l-5"><b>Sign Up</b></a></p>
                        </div>
                    </div> -->
                </form>

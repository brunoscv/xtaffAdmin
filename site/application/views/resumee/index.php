...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <header class="" id="section-colab" style="margin: 0 0 4em 0">
            <div class="container">
                <div class="row">
                ...
                <div class="row"> 
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                        <a class="btn mt-4" href="#" style="background-color: #fff; color: #35A88E; margin: 0 auto; font-family: 'Lato', sans-serif; font-weight:700; line-height:1.6em; text-transform:uppercase">Preencha o Currículo</a>
                    </div> 
                </div>
            </div>
        </header>
